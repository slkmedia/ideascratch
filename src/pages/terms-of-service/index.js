  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        carefully before using the https://ideascratch.com website (the
        "Service") operated by SLK Media ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        Service. This Terms of Service agreement for IdeaScratch is managed by{' '}
        <a href="https://termsfeed.com/terms-service/generator/">
          TermsFeed's Terms of Service Generator
        </a>
        .
      </p>
      ...
      <p>
        ...
        are not owned or controlled by IdeaScratch.
      </p>

      <p>
        IdeaScratch has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that IdeaScratch shall not
      ...
      <p>
        ...
        <a href="mailto:team@slk.media">team@slk.media</a>.
      </p>
    </Fragment>
  );
}
